                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <?php echo anchor('doctor',tr('DoctorsList'));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <i class="small material-icons materialsidebar" style="margin-right: 3px">add_box</i> </span>
                            <?php echo anchor('doctor/new_doctor',tr('NewDoctor'));?>
                        </td>
                    </tr>
                </tbody>
            </table>
