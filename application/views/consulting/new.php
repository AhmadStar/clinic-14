        ...
        <div class="pull-right" title="<?php trP('GoToConsultings')?>">
            ...
            <?php 
                if($this->bitauth->has_role('admin')){
                    echo anchor('consulting', '<button class="btn btn-return"><span>'.tr('ReturnToConsultings').'</span></button>');
                }
                else echo anchor('consulting/userconsulting', '<button class="btn btn-return"><span>'.tr('GoToConsultings').'</span></button>');
                    ?>
        </div>
    </div>
